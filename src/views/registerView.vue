        ...
        <div class="box-login  h-[700px] w-[1000px] flex ">
            ...
            <div class="left h-full w-[500px]">
                ...
                <div class="flex flex-col items-center gap-2">
                    <input type="text" placeholder="Full Name" class="input-cs w-[400px] p-2 "></input>
                    <input type="text" placeholder="Email" class="input-cs w-[400px] p-2 "></input>
                    <input type="text" placeholder="Password" class="input-cs w-[400px] p-2 "></input>
                    <input type="text" placeholder="Repeat Password" class="input-cs w-[400px] p-2 "></input>
                </div>
